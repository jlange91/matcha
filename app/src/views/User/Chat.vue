<template>
  <div class="flex flex-wrap">
    <div
      class="flex flex-wrap items-start content-start w-full lg:w-1/3 border-r border-grey-lighter h-full"
    >
    ...
    <div class="w-full lg:w-2/3">
      ...
      <div v-if="focus_id" class="w-full">
        <div class="overflow-hidden">
          <div class="flex flex-col p-4 overflow-auto h-64">
            ...
            <div
              ...
              :key="message.id"
              :class="backgroundColor(message.from_id)"
              class="rounded-lg text-sm p-3 mb-1"
            >
        ...
        <div v-if="seen" class="flex flex-row-reverse">
          <span
            class="py-1 px-2 shadow-md no-underline rounded-full bg-blue-600 text-white font-sans font-semibold text-xs border-blue btn-primary"
          >Vu.</span>
        </div>
